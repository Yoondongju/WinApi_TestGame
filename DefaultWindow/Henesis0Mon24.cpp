...
CHenesis0Mon24::CHenesis0Mon24()
	: m_dwTime(0)
	, m_fStartX(5000.f), m_fStartY(1200.f)
	, m_fT(0.f)
{
}
...
void CHenesis0Mon24::Initialize()
{
...
int CHenesis0Mon24::Update()
{
	// 몬스터 이동 및 방향 전환

	m_fT += 0.01f;
	m_tInfo.fX = m_fStartX + (300.f * cos(2.33f * m_fT) * cos(m_fT));
	m_tInfo.fY = m_fStartY + (300.f * cos(2.33f * m_fT) * sin(m_fT));
...
void CHenesis0Mon24::Late_Update()
{
}

void CHenesis0Mon24::Render(HDC hDC)
{
