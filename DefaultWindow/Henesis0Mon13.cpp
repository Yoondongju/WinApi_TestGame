...
CHenesis0Mon13::CHenesis0Mon13()
	: m_dwTime(0)
	, m_fStartX(1700.f), m_fStartY(1200.f)
	, m_fT(0.f)
{
}
...
void CHenesis0Mon13::Initialize()
{
...
int CHenesis0Mon13::Update()
{
	// 몬스터 이동 및 방향 전환

	m_fT += 0.01f;
	m_tInfo.fX = m_fStartX + (100.f * sin(5.f * m_fT + (PI * 0.5)));
...
void CHenesis0Mon13::Late_Update()
{
}

void CHenesis0Mon13::Render(HDC hDC)
{
