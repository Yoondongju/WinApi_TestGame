...
CHenesis0_Boss1::CHenesis0_Boss1()
	: m_dwTime(0)
	, m_fRootX(4700.f), m_fRootY(1100.f)
	, m_fRangeX(200.f), m_fRangeY(200.f)
	, m_fAngle(60.f), m_fDistance(200.f)
{
}
...
void CHenesis0_Boss1::Initialize()
{
...
void CHenesis0_Boss1::Late_Update()
{
}

void CHenesis0_Boss1::Render(HDC hDC)
{
