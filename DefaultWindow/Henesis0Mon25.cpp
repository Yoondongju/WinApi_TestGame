...
CHenesis0Mon25::CHenesis0Mon25()
	: m_dwTime(0)
	, m_fStartX(5500.f), m_fStartY(1200.f)
	, m_fT(0.f)
{
}
...
void CHenesis0Mon25::Initialize()
{
...
int CHenesis0Mon25::Update()
{
	// 몬스터 이동 및 방향 전환

	m_fT += 0.03f;
	m_tInfo.fX = m_fStartX + (300.f * cos(1.25f * m_fT) * cos(m_fT));
	m_tInfo.fY = m_fStartY + (300.f * cos(1.25f * m_fT) * sin(m_fT));
...
void CHenesis0Mon25::Late_Update()
{
}

void CHenesis0Mon25::Render(HDC hDC)
{
