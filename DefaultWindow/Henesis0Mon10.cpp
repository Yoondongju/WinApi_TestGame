...
CHenesis0Mon10::CHenesis0Mon10()
	: m_dwTime(0)
	, m_fStartX(200.f), m_fStartY(1200.f)
	, m_fT(0.f)
{
}
...
void CHenesis0Mon10::Initialize()
{
...
int CHenesis0Mon10::Update()
{
	// 몬스터 이동 및 방향 전환

	m_fT += 0.03f;
	m_tInfo.fX = m_fStartX + (100.f * sin(2.f * m_fT ));
	m_tInfo.fY = m_fStartY + (200.f * sin(1.f * m_fT + (PI * 0.5)));
...
void CHenesis0Mon10::Late_Update()
{
}

void CHenesis0Mon10::Render(HDC hDC)
{
