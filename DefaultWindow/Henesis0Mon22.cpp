...
CHenesis0Mon22::CHenesis0Mon22()
	: m_dwTime(0)
	, m_fStartX(3500.f), m_fStartY(1200.f)
	, m_fT(0.f)
{
}
...
void CHenesis0Mon22::Initialize()
{
...
int CHenesis0Mon22::Update()
{
	// 몬스터 이동 및 방향 전환

	m_fT += 0.005f;
	m_tInfo.fX = m_fStartX + (300.f * cos(12.f * m_fT) * cos(m_fT));
	m_tInfo.fY = m_fStartY + (300.f * cos(12.f * m_fT) * sin(m_fT));
...
void CHenesis0Mon22::Late_Update()
{
}

void CHenesis0Mon22::Render(HDC hDC)
{
