...
CHenesis0_Boss4::CHenesis0_Boss4()
	: m_dwTime(0)
	, m_fRootX(4700.f), m_fRootY(1100.f)
	, m_fRangeX(200.f), m_fRangeY(200.f)
	, m_fAngle(240.f), m_fDistance(200.f)
{
}
...
void CHenesis0_Boss4::Initialize()
{
...
void CHenesis0_Boss4::Late_Update()
{
}

void CHenesis0_Boss4::Render(HDC hDC)
{
