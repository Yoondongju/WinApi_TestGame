...
CHenesis0Mon11::CHenesis0Mon11()
	: m_dwTime(0)
	, m_fStartX(700.f), m_fStartY(1200.f)
	, m_fT(0.f)
{
}
...
void CHenesis0Mon11::Initialize()
{
...
int CHenesis0Mon11::Update()
{
	// 몬스터 이동 및 방향 전환

	m_fT += 0.03f;
	m_tInfo.fX = m_fStartX + (100.f * sin(3.f * m_fT + (PI * 0.5)));
	m_tInfo.fY = m_fStartY + (100.f * sin(2.f * m_fT));
...
void CHenesis0Mon11::Late_Update()
{
}

void CHenesis0Mon11::Render(HDC hDC)
{
